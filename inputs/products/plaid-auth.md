...
last_ai_update: "2026-06-17T13:03:08.259Z"
needs_review: true
approved: true
version: 1
...
### 2026-06-17 — Run: 2026-06-17-Citi-Auth-Identity-Signal-Transfer-v1 (min_confidence: medium)
...
- [high] {"claim":"Single Plaid Link connection returns both Auth (account/routing) and Identity Match ownership signals, and feeds Signal ACH return-risk scoring — so Citi verifies ownership, pulls ACH rails, and scores risk in one flow","source":"Integration Skill + Priority Messaging"}
