...
| [Layer](inputs/products/plaid-layer.md) | Mobile mock HARD CONTRACT. Helper `415-555-1111`=eligible, `415-555-0011`=ineligible. Prefill only (unverified) → chain [IDV](inputs/products/plaid-identity-verification.md) to KYC. Canonical skeleton + logo rules in product file. |
