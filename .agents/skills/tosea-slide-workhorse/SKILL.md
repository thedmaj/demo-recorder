---
name: tosea-slide-workhorse
description: >-
  Tier A "Workhorse" HTML slide skill from the Tosea awesome-html-slide-skills
  library — balanced visual quality and generation speed for internal decks,
  engineering reviews, and project proposals. Implemented via lewislulu/html-ppt-skill
  (HTML PPT Studio). Use when the user asks for HTML presentations, PPT, slides,
  deck, keynote, slideshow, pitch deck, tech sharing, or mentions "Workhorse template"
  from Tosea. Triggers include presentation, ppt, slides, deck, workhorse, html slides.
---

# tosea-slide-workhorse (Tier A · Workhorse)

Curated **Tier A Workhorse** skill from [ToseaAI/awesome-html-slide-skills](https://github.com/ToseaAI/awesome-html-slide-skills) — clean professional layouts, high reliability, tolerant of outlines or rough notes. Backed by **HTML PPT Studio** ([lewislulu/html-ppt-skill](https://github.com/lewislulu/html-ppt-skill)).

> **Note:** The blog documents `clawhub install tosea-slide-workhorse`; that ClawHub slug is not published yet (404 as of 2026-05-25). This project install uses the curated Tier A implementation above.

> **Claude Agent mode (canonical):** This directory is the source of truth for layout assets. Cursor mirror: `.cursor/skills/tosea-slide-workhorse/SKILL.md`.

> **Pipeline slides:** Load **[plaid-workhorse-slides](../plaid-workhorse-slides/SKILL.md)** first — Plaid brand overrides Workhorse themes; static slides, SVG-only charts.
...
```bash
npx skills add https://github.com/lewislulu/html-ppt-skill --agent cursor
```
